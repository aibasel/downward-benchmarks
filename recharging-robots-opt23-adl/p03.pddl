;; Genearated with: ../../../domain-recharging-robots/generator.py single-source-move-to-locations --random-seed 1237 6 7 10 1 p03.pddl p03.plan
;; Random seed: 1237
(define (problem recharge-single-source-move-to-locations-1742)
...
(:goal
  (and
    (at robot-00 location-0034)
    (at robot-01 location-0023)
    (at robot-02 location-0027)
    (at robot-03 location-0009)
    (at robot-04 location-0004)
    (at robot-05 location-0028)
  )
)
