...
(define (problem ricochet-robots-16x16-None-446207)
...
(:init
    ...
    (BLOCKED cell-11-16 west)
    (BLOCKED cell-10-16 east)
    ...
    (BLOCKED cell-1-4 north)
    (BLOCKED cell-1-3 south)
    ...
    (BLOCKED cell-10-11 east)
    (BLOCKED cell-11-11 west)
    (BLOCKED cell-13-1 west)
    ...
    (at robot-1 cell-11-16) ;; red
    (at robot-2 cell-15-5) ;; blue
    (at robot-3 cell-5-10) ;; green
    (at robot-4 cell-14-12) ;; yellow
