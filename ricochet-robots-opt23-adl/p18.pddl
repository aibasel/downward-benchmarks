...
(define (problem ricochet-robots-18x18-None-542747)
...
(:init
    ...
    (BLOCKED cell-5-14 east)
    (BLOCKED cell-6-14 west)
    ...
    (BLOCKED cell-5-1 east)
    (BLOCKED cell-6-1 west)
    (BLOCKED cell-18-2 north)
    (BLOCKED cell-18-1 south)
    (BLOCKED cell-17-11 west)
    (BLOCKED cell-16-11 east)
    (BLOCKED cell-5-16 south)
    (BLOCKED cell-5-17 north)
    (BLOCKED cell-14-15 west)
    (BLOCKED cell-13-15 east)
    (BLOCKED cell-4-6 south)
    (BLOCKED cell-4-7 north)
    (BLOCKED cell-17-9 east)
    (BLOCKED cell-18-9 west)
    (BLOCKED cell-12-17 north)
    ...
    (BLOCKED cell-12-5 west)
    (BLOCKED cell-11-5 east)
    ...
    (at robot-1 cell-15-18) ;; red
    (at robot-2 cell-9-4) ;; blue
    (at robot-3 cell-12-2) ;; green
    (at robot-4 cell-3-16) ;; yellow
