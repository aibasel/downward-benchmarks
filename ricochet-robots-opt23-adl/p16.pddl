...
(define (problem ricochet-robots-16x16-None-426848)
...
(:init
    ...
    (BLOCKED cell-16-14 south)
    (BLOCKED cell-16-15 north)
    (BLOCKED cell-7-10 west)
    (BLOCKED cell-6-10 east)
    ...
    (BLOCKED cell-16-7 south)
    (BLOCKED cell-16-8 north)
    (BLOCKED cell-12-6 south)
    (BLOCKED cell-12-7 north)
    ...
    (at robot-1 cell-12-8) ;; red
    (at robot-2 cell-6-3) ;; blue
    (at robot-3 cell-1-16) ;; green
    (at robot-4 cell-12-6) ;; yellow
